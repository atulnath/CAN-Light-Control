 ...
 ********************************************************************/
    ...
    /* STD_ID */
    CAN_0.BUF[8].ID.B.STD_ID = 0x101; /* Gear message id */
    ...
    /* STD_ID */
    CAN_0.BUF[9].ID.B.STD_ID = 0x102; /* doors sensor message id */
    ...
    /* STD_ID */
    CAN_0.BUF[10].ID.B.STD_ID = 0x103; /* fuel level warning message id */

    /* Buffer 3 */
    /* MB Code */
    CAN_0.BUF[11].CS.B.CODE = 8;
    /* Standard format */
    ...
    /* STD_ID */
    CAN_0.BUF[11].ID.B.STD_ID = 0x104; /* engine cooling warning message id*/

    /* Buffer 4 */
    /* MB Code */
    CAN_0.BUF[12].CS.B.CODE = 8;
    /* Standard format */
    ...
    /* Data Length */
    CAN_0.BUF[12].CS.B.LENGTH = 0;
    /* STD_ID */
    CAN_0.BUF[12].ID.B.STD_ID = 0x105; /* alive signal message id */

    /* Buffer 5 */
    /* MB Code */
    CAN_0.BUF[13].CS.B.CODE = 8;
    /* Standard format */
    CAN_0.BUF[13].CS.B.IDE = 0;
    /* SRR */
    CAN_0.BUF[13].CS.B.SRR = 0;
    /* Data Frame */
    CAN_0.BUF[13].CS.B.RTR = 0;
    /* Data Length */
    CAN_0.BUF[13].CS.B.LENGTH = 0;
    /* STD_ID */
    CAN_0.BUF[13].ID.B.STD_ID = 0x106; /* error signal message id */
